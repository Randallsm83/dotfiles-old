...
require('lazy').setup({
    ...
    {'morhetz/gruvbox', name = 'gruvbox-morhetz', priority = 1000}, -- Lualine
    {
    ...
    { -- LSP Plugins
        ...
        config = function()
            ...
            vim.list_extend(ensure_installed, {
                ...
                'bashls', 'shellcheck', 'shellharden', 'shfmt', 'beautysh',
                'lua_ls', 'stylua', 'luacheck', 'luaformatter',
                'jsonls', 'jsonlint', 'jq',
                'html', 'htmlbeautifier', 'htmlhint',
                'prettier', 'prettierd', 'eslint', 'eslint_d', 'standardjs',
                'ts_ls', 'vtsls', 'ts-standard',
                'perlnavigator',
                'pylsp',
                'vimls', 'vint',
            })
